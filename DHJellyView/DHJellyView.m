...
//  TestJellyPath
//
//  Created by DavidHuang on 16/1/11.
...
#define  MIN_HEIGHT  self.frame.size.height
@interface DHJellyView()
...
@end
@implementation DHJellyView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = [UIColor colorWithRed:57/255.0 green:67/255.0 blue:89/255.0 alpha:1.0];
